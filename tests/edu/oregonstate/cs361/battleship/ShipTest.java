...
class ShipTest {
    ...
    public void testPlaceShip() {
        Ship s = new Ship("AircraftCarrier",5, new Coordinate(5,2),new Coordinate(5,7),true);
        assertEquals(true,s.covers(new Coordinate(5,2)));
    }

    @Test
    public void testPlaceShipHorizontal() {
        Ship s = new Ship("AircraftCarrier",5, new Coordinate(5,2),new Coordinate(10,2),true);
    ...
    public void testPlaceShipVerticalNoLocation() {
        Ship s = new Ship("AircraftCarrier",5,new Coordinate(0,0),new Coordinate(9,9),true);
        assertEquals(false,s.covers(new Coordinate(1,1)));
    }
