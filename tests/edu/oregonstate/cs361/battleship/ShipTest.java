...
class ShipTest {
    ...
    public void testPlaceShip() {
        Ship s = new Ship("AircraftCarrier",5, new Coordinate(5,2),new Coordinate(5,6),false);
        assertEquals(true,s.covers(new Coordinate(5,2)));
    }

    @Test
    public void testPlaceShipHorizontal() {
        Ship s = new Ship("AircraftCarrier",5, new Coordinate(5,2),new Coordinate(9,2),false);
